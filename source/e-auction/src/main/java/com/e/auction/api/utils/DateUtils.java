package com.e.auction.api.utils;
...
public class DateUtils {
    ...
    public static Date convertToUtc(Date source, TimeZone oldTimeZone) throws ParseException {
        SimpleDateFormat simpleDateFormatUtc = new SimpleDateFormat(EAuctionConstant.DATE_TIME_FORMAT);

        SimpleDateFormat oldTimezoneFormat = new SimpleDateFormat(EAuctionConstant.DATE_TIME_FORMAT);
