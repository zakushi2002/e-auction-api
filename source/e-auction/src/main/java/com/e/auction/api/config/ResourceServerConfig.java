...
import com.e.auction.api.config.security.CustomTokenConverter;
import com.e.auction.api.config.security.JsonToUrlEncodedAuthenticationFilter;
...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http.addFilterAfter(jsonFilter, BasicAuthenticationFilter.class)
                ...
                .antMatchers("/v1/user-account/**").permitAll()
                ...
                .antMatchers("/v1/bid-history/**").permitAll()
                .antMatchers("/v1/category/**").permitAll()
                .antMatchers("/v1/payment/return").permitAll()
                .antMatchers("/v1/payment/**").permitAll()
    ...
    public void configure(ResourceServerSecurityConfigurer resources) throws Exception {
        resources.resourceId("e-auction-service");
    }
}